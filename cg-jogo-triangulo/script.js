...
let p1 = new Ponto(200, 300)
let p2 = new Ponto(300, 300)
let p3 = new Ponto(250, 150)

draw(p1, p2, p3)

let x1 = new Ponto(10, 300)
let x2 = new Ponto(20, 300)
let x3 = new Ponto(20, 270)
let x4 = new Ponto(10, 270)

draw2(x1, x2, x3, x4)

setInterval(() => {
  p1.transladar(4, 'esquerda')
  p2.transladar(4, 'esquerda')
  p3.transladar(4, 'esquerda')
  draw(p1, p2, p3)
  draw2(x1, x2, x3, x4)
}, 1000);
...
document.addEventListener('keydown', function(event) {
  if (event.key === "ArrowUp") {
    x1.transladar(10, 'cima')
    x2.transladar(10, 'cima')
    x3.transladar(10, 'cima')
  } 
})
...
// // let p2 = new Ponto(document.getElementById('p2-x').value, document.getElementById('p2-y').value)
// // let p3 = new Ponto(document.getElementById('p3-x').value, document.getElementById('p3-y').value)
// let p1 = new Ponto(300, 200)
// let p2 = new Ponto(300, 300)
// let p3 = new Ponto(150, 150)
// const triangulo = new Triangulo(p1, p2, p3);
// // if (triangulo.isTriangulo()) {
// //   draw(p1, p2, p3);
// //   document.getElementById('escala').removeAttribute('hidden')
