...
$uri = 'http://api.football-data.org/v4/competitions/BSA/matches';
  $reqPrefs['http']['method'] = 'GET';
  $reqPrefs['http']['header'] = 'X-Auth-Token: bef4843a927541c5b894ff0c1d3c78ae';
  $stream_context = stream_context_create($reqPrefs);
  $response = file_get_contents($uri, false, $stream_context);
...
$uri = 'http://api.football-data.org/v4/competitions/PPL/matches';
  $reqPrefs['http']['method'] = 'GET';
  $reqPrefs['http']['header'] = 'X-Auth-Token: bef4843a927541c5b894ff0c1d3c78ae';
  $stream_context = stream_context_create($reqPrefs);
  $response = file_get_contents($uri, false, $stream_context);
...
$uri = 'http://api.football-data.org/v4/competitions/BL1/matches';
  ...
  $uri = 'http://api.football-data.org/v4/competitions/DED/matches';
  $reqPrefs['http']['method'] = 'GET';
  $reqPrefs['http']['header'] = 'X-Auth-Token: bef4843a927541c5b894ff0c1d3c78ae';
  $stream_context = stream_context_create($reqPrefs);
  $response = file_get_contents($uri, false, $stream_context);
...
// echo json_encode($competitions);
  $nome_arquivo = 'matches.json';
  $handle = fopen($nome_arquivo, 'w');
  fwrite($handle, json_encode($matches));
  fclose($handle);
