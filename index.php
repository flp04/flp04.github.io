...
<body>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-1.jpg');">
                    <div class="img-bg-inner">
                      <h2 id="temperatura-atual-titulo">The Best Homemade Masks for Face (keep the Pimples Away)</h2>
                      <p id="temperatura-atual-texto">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem neque est mollitia! Beatae minima assumenda repellat harum vero, officiis ipsam magnam obcaecati cumque maxime inventore repudiandae quidem necessitatibus rem atque.</p>
                      <p id="temperatura-maxima" style="font-size: 16px;"></p>
                      <p id="temperatura-minima" style="font-size: 16px;"></p>
                    </div>
                  </a>
                </div>
                ...
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-2.jpg');">
                    <div class="img-bg-inner">
                      <h2 id="previsao-amanha-titulo"></h2>
                      <p id="previsao-amanha-maxima"></p>
                      <p id="previsao-amanha-minima"></p>
                    </div>
                  </a>
                </div>
  ...
  <script>
    ...
    var temperatura_maxima
    var temperatura_minima
    var previsao_amanha
    var local
    ...
    try {
      let x = {'https://api.football-data.org/v4/teams/65/matches?status=FINISHED&limit=1', headers: { "X-Auth-Token": bef4843a927541c5b894ff0c1d3c78ae }}
    ...
    //   console.log(response.data.forecast.forecastday[0].day.maxtemp_c)
    ...
    //   document.getElementById('temperatura-atual-titulo').innerText = `Temperatura atual em ${local} ${temperatura_atual}`
    //   document.getElementById('temperatura-atual-texto').innerText = response.data.forecast.forecastday[0].day.condition.text
    //   document.getElementById('previsao-amanha-titulo').innerText = 'Previsão para Amanhã'
    //   document.getElementById('previsao-amanha-maxima').innerText = 'Máxima: ' + previsao_amanha.maxima
    //   document.getElementById('previsao-amanha-minima').innerText = 'Mínima: ' + previsao_amanha.minima
    //   document.getElementById('temperatura-maxima').innerText = 'Temperatura máxima: ' + temperatura_maxima
    //   document.getElementById('temperatura-minima').innerText = 'Temperatura mínima: ' + temperatura_minima
    // } catch (error) {
    //   console.log(error)
    // }
  }
  getClima()
  document.getElementById('titulo').innerText = `Temperatura atual: ${temperatura_atual}`
